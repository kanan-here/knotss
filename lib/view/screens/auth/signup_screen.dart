      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child : Column(
            ...
            children: [
              GlitchEffect(child: const Text("Welcome To Knots" ,style: TextStyle(fontWeight: FontWeight.w900 , fontSize: 30),)),
              SizedBox(height: 25,),
              InkWell(
                onTap: () {
                ...
                child: Stack(
                  children: [
                    const CircleAvatar(backgroundImage: NetworkImage(
                        "https://st3.depositphotos.com/1767687/16607/v/450/depositphotos_166074422-stock-illustration-default-avatar-profile-icon-grey.jpg"), radius: 60,),
