...
import 'addcaptions_screen.dart';
class addVideoScreen extends StatelessWidget {
  ...
  videoPick(ImageSource src , BuildContext context) async{
    ...
    if(video != null){
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=> addcaptions_Screen(videoFile: File(video.path), videoPath: video.path)));
