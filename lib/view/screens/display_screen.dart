...
import 'package:untitled2/view/screens/comment_screen.dart';
import 'package:untitled2/view/screens/profile_screen.dart';
import 'package:untitled2/view/widgets/AlbumRotator.dart';
import 'package:untitled2/view/widgets/ProfileButton.dart';
import 'package:untitled2/view/widgets/KnotsVideoPlayer.dart';
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ChatScreen(id : data.id)));
                              },
                              child: Column(
                                children: [
                                  Icon(
